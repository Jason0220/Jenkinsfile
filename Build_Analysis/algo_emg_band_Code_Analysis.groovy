            ...
            steps {
                checkout([$class: 'GitSCM', 
                    ...
                    userRemoteConfigs: [[credentialsId: 'Jenkins', 
                        ...
                        url: 'ssh://10.10.192.13:29418/algo_emg_band']]])
            }
        }
            ...
            steps {
                withSonarQubeEnv('SonarQube_46') {
                    sh """
                        ...
                        echo "sonar.projectKey=algo_emg_band" >> sonar-project.properties
                        sonar-scanner \
                            -Dsonar.projectKey=algo_emg_band \
                            -Dsonar.branch.name=${env.GERRIT_BRANCH} \
                            -Dsonar.sources=. \
                            -Dsonar.host.url=http://10.10.192.46:9000/sonarqube \
                            -Dsonar.login=sqp_333ed01092bb963fa968006ac9098cab49352b85
                    """
                }
            }
        }
