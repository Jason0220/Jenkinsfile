            ...
            steps {
                checkout([$class: 'GitSCM', 
                    ...
                    userRemoteConfigs: [[credentialsId: 'Jenkins', 
                        ...
                        url: 'ssh://10.10.192.13:29418/VOSM']]])
            }
        }
            ...
            steps {
                withSonarQubeEnv('SonarQube_46') {
                    sh """
                        ...
                        echo "sonar.projectKey=VOSM" >> sonar-project.properties
                        sonar-scanner \
                            -Dsonar.projectKey=VOSM \
                            -Dsonar.branch.name=${env.GERRIT_BRANCH} \
                            -Dsonar.sources=. \
                            -Dsonar.host.url=http://10.10.192.46:9000/sonarqube \
                            -Dsonar.login=sqp_84fe1f780ad5346bf41d5ee41e65cab407980a37
                    """
                }
            }
        }
