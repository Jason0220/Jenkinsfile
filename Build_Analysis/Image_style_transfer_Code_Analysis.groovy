            ...
            steps {
                checkout([$class: 'GitSCM', 
                    ...
                    userRemoteConfigs: [[credentialsId: 'Jenkins', 
                        ...
                        url: 'ssh://10.10.192.13:29418/Image_style_transfer']]])
            }
        }
            ...
            steps {
                withSonarQubeEnv('SonarQube_46') {
                    sh """
                        ...
                        echo "sonar.projectKey=Image_style_transfer" >> sonar-project.properties
                        sonar-scanner \
                            -Dsonar.projectKey=Image_style_transfer \
                            -Dsonar.branch.name=${env.GERRIT_BRANCH} \
                            -Dsonar.sources=. \
                            -Dsonar.host.url=http://10.10.192.46:9000/sonarqube \
                            -Dsonar.login=sqp_2eea1df737a8bbfe764f75226160c8e6cac2f891
                    """
                }
            }
        }
