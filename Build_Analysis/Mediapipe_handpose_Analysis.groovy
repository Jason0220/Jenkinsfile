            ...
            steps {
                checkout([$class: 'GitSCM', 
                    ...
                    userRemoteConfigs: [[credentialsId: 'Jenkins', 
                        ...
                        url: 'ssh://10.10.192.13:29418/Mediapipe_handpose']]])
            }
        }
            ...
            steps {
                withSonarQubeEnv('SonarQube_46') {
                    sh """
                        ...
                        echo "sonar.projectKey=Mediapipe_handpose" >> sonar-project.properties
                        sonar-scanner \
                            -Dsonar.projectKey=Mediapipe_handpose \
                            -Dsonar.branch.name=${env.GERRIT_BRANCH} \
                            -Dsonar.sources=. \
                            -Dsonar.host.url=http://10.10.192.46:9000/sonarqube \
                            -Dsonar.login=sqp_3874387ed608d0100311fbb402eb0fc940c0e88a
                    """
                }
            }
        }
