            ...
            steps {
                checkout([$class: 'GitSCM', 
                    ...
                    userRemoteConfigs: [[credentialsId: 'Jenkins', 
                        ...
                        url: 'ssh://10.10.192.13:29418/MLLM_Foundation']]])
            }
        }
            ...
            steps {
                withSonarQubeEnv('SonarQube_46') {
                    sh """
                        ...
                        echo "sonar.projectKey=MLLM_Foundation" >> sonar-project.properties
                        sonar-scanner \
                            -Dsonar.projectKey=MLLM_Foundation \
                            -Dsonar.branch.name=${env.GERRIT_BRANCH} \
                            -Dsonar.sources=. \
                            -Dsonar.host.url=http://10.10.192.46:9000/sonarqube \
                            -Dsonar.login=sqp_53338204d656958655c836ba32068bad39d61b60
                    """
                }
            }
        }
