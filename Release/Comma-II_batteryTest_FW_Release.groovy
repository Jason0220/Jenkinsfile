pipeline {
    ...
    stages {
        ...
        stage('CODE_SYNC') {
            ...
            steps {
                checkout scmGit(branches: [[name: '*/batteryTest']], 
                extensions: [], 
                ...
                dir("${env.WORKSPACE}") {
                    script {
                        ...
                        sh """
                            ...
                            cd out
                            zip -r "commaii_${params.SKU}_batteryTest_${params.APP_VERSION}.\$(date +%Y%m%d%H%M).zip" * || { echo "Zip failed"; exit 1; }
                        """
            ...
            steps {
                script {
                    withEnv([
                        ...
                        sh """
                            url="http://10.10.192.15:8081/artifactory/comma-ii-\$SKU/Release/batteryTest_\$APP_VERSION.\$(date +%Y%m%d%H%M)"
                            echo \$url
